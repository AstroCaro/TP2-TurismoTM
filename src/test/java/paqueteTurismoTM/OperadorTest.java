...
public class OperadorTest {
	...
	public static class testConOfertasDeBaseDeDatos { // utiliza el @Before y el @After
		...
		public void filtrosDeOroYTiempoTest() {
			...
			// Promociones de la preferencia
			ofertasEsperadas.remove(0);// xxxxx PromocionPorcentual 1 AVENTURA Costo: 22 Tiempo: 7 xxxxx No le alcanza
										// el presupuesto
			// 0 PromocionPorcentual 2 AVENTURA Costo: 17 Tiempo: 7 >>>>> Puede comprar
			ofertasEsperadas.remove(1);// xxxxx PromocionAxB 2 AVENTURA Costo: 13 Tiempo:9 xxxxx No le alcanza el
										// tiempo
			...
			// Promociones que no son de la preferencia
			ofertasEsperadas.remove(4);// xxxxx PromocionAbsoluta1 DEGUSTACION Costo: 36 Tiempo: 7.5 xxxxx No le
										// alcanza el presupuesto y el tiempo
			ofertasEsperadas.remove(4);// xxxxx PromocionAxB 1 PAISAJE Costo: 17 Tiempo: 7.5 xxxxx No le alcanza el
										// tiempo
			// 4 PromocionAbsoluta2 PAISAJE Costo: 15 Tiempo: 5.5 >>>>> Puede comprar

			// Atracciones que no son de la preferencia
			ofertasEsperadas.remove(5);// xxxxx Lothlorien DEGUSTACION Costo: 35 Tiempo: 1 xxxxx No le alcanza el
										// presupuesto
